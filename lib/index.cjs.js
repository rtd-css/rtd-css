...
})(exports.CssTree || (exports.CssTree = {}));
...
class LowLevelCompiler {
    ...
    processChildNodesOfNode(node, newParent, parentDevice) {
        node.each((child) => {
            if (child.type === exports.CssTree.NodeType.atrule) {
                this.processAtRule(child, newParent, parentDevice);
            }
            else if (child.type === exports.CssTree.NodeType.rule) {
                this.processRule(child, newParent, parentDevice);
            }
            else if (child.type === exports.CssTree.NodeType.decl) {
                this.processDecl(child, newParent);
            }
        });
    }
    processAtRule(atRule, newParent, parentDevice) {
        if (atRule.name === exports.CssTree.AtRuleName.media) {
    ...
    loadConfigString(root, removeConfigDecl = false) {
        ...
        root.each((node) => {
            if (node.type === exports.CssTree.NodeType.rule) {
                const rule = node;
                if (rule.selector.toLowerCase() === 'html') {
                    rule.each((node) => {
                        if (node.type === exports.CssTree.NodeType.decl) {
                            const decl = node;
...
(function (PostcssCssTree) {
    ...
    class Root extends ContainerBase {
        ...
        get type() {
            return exports.CssTree.NodeType.root;
        }
    ...
    class AtRule extends ChildContainerBase {
        ...
        get type() {
            return exports.CssTree.NodeType.atrule;
        }
        get name() {
    ...
    class Rule extends ChildContainerBase {
        ...
        get type() {
            return exports.CssTree.NodeType.rule;
        }
    ...
    class Declaration extends ChildNode {
        ...
        get type() {
            return exports.CssTree.NodeType.decl;
        }
    ...
    class Comment extends ChildNode {
        ...
        get type() {
            return exports.CssTree.NodeType.comment;
        }
...
exports.PostcssCssDriver = PostcssCssDriver;
exports.postcssRtdCssPlugin = postcssRtdCssPlugin;
