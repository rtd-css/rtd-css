...
class FileCompiler {
	compile(inputFilePath, outputDirectoryPath, cssDriver = defaultCssDriver) {
		...
		for (const outFileOptions of outFileOptionsList) {
			const outputResult = compiler.compile(inputRoot, outFileOptions.compileOptions, cssDriver);
...
FileCompiler.cssNamespaceExt = '.rtd';
